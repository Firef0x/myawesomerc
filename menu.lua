xdgmenu = function(terminal)
  return {
    {'网络 (&I)', --[[/usr/share/desktop-directories/Arch-Internet.directory]] {
        ...
        -- {'Git Cola', 'git-cola --repo', '/usr/share/icons/hicolor/scalable/apps/git-cola.svg' --[[/usr/share/applications/git-cola-folder-handler.desktop]]},
        {'Git Cola', 'git-cola --prompt', '/usr/share/icons/hicolor/scalable/apps/git-cola.svg' --[[/usr/share/applications/git-cola.desktop]]},
        {'Git DAG', 'git-dag --prompt', '/usr/share/icons/hicolor/scalable/apps/git-cola.svg' --[[/usr/share/applications/git-dag.desktop]]},
