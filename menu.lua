xdgmenu = function(terminal)
  return {
    {'网络 (&I)', --[[/usr/share/desktop-directories/Arch-Internet.directory]] {
        ...
        {'Firefox 网络浏览器', 'firefox', '/usr/share/icons/hicolor/16x16/apps/firefox.png' --[[/usr/share/applications/firefox.desktop]]},
        ...
        {'wiznote', 'wiznote', '/usr/share/icons/hicolor/16x16/apps/wiznote.png' --[[/usr/share/applications/wiznote.desktop]]},
        {'归档管理器', 'file-roller', '/usr/share/icons/hicolor/16x16/apps/file-roller.png' --[[/usr/share/applications/file-roller.desktop]]},
      }
    }
  }
end
